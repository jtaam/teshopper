...
//            exit();
    ...
    public function update(Request $request, $product_id){
        ...
        if ($image) {
            ...
            if ($success) {
                ...
                DB::table('tbl_products')
                    ->where('product_id', $product_id)
                    ->update($data);
                Session::put('message','<p class="alert alert-success">Product updated successfully!!</p>');
                return Redirect::to('/all-product');
                // echo "<pre>";
                // print_r($data);
                // echo "</pre>";
        ...
        DB::table('tbl_products')
            ->where('product_id', $product_id)
            ->update($data);
        Session::put('message','<p class="alert alert-success">Product updated successfully without image!!</p>');
        return Redirect::to('/all-product');
    }
