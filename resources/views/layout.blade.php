...
<body>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('frontend/images/home/girl1.jp')}}g" class="girl img-responsive" alt="" />
                                    <img src="{{asset('frontend/images/home/pricing.pn')}}g"  class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
    ...
    <script src="{{URL::to('frontend/js/jquery.scrollUp.min.js')}}"></script>
