...
@section('content')
    ...
    @foreach($product_by_brand as $v_brand_by_product)
        @if(null == $v_brand_by_product)
            <div class="col-sm-4">
                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{URL::to($v_brand_by_product->product_image)}}" style="height: 300px;"
                                 alt=""/>
                            <h2>{{$v_brand_by_product->product_price}} Tk</h2>
