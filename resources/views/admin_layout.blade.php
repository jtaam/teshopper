        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{URL::to('all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categories</span></a>
                    </li>
                    <li><a href="{{URL::to('add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a>
                    </li>

                    <li><a href="{{URL::to('all-brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a>
                    </li>
                    <li><a href="{{URL::to('add-brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brand</span></a>
                    </li>
                    <li>
...
<script src="{{asset('http://localhost:8888/LocalAssets/bootbox/bootbox.js')}}"></script>
<script>
