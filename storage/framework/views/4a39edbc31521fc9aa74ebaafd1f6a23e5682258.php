...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html"><span>Elaravel</span></a>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    <li><a href="<?php echo e(URL::to('/dashboard')); ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a>
                    </li>

                    <li><a href="<?php echo e(URL::to('all-category')); ?>"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categories</span></a>
                    </li>
                    <li><a href="<?php echo e(URL::to('add-category')); ?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a>
                    </li>

                    <li><a href="<?php echo e(URL::to('all-brand')); ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a>
                    </li>
                    <li><a href="<?php echo e(URL::to('add-brand')); ?>"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brand</span></a>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="<?php echo e(URL::to('all-product')); ?>"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> All Products</span></a></li>
                            <li><a class="submenu" href="<?php echo e(URL::to('add-product')); ?>"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> Add Product</span></a></li>
                            
                        </ul>
                    </li>
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close"></i><span class="hidden-tablet"> Sliders</span></a>
                        <ul>
                            <li><a class="submenu" href="<?php echo e(URL::to('all-slider')); ?>"><i class="icon-file-alt"></i><span
                                            class="hidden-tablet"> All Sliders</span></a></li>
                            <li><a class="submenu" href="<?php echo e(URL::to('add-slider')); ?>"><i class="icon-file-alt"></i><span
...
<script src="<?php echo e(asset('http://localhost:8888/LocalAssets/bootbox/bootbox.js')); ?>"></script>
<script>
