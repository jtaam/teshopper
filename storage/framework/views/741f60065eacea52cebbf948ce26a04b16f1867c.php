...
<body>
    ...
    <script src="<?php echo e(URL::to('frontend/js/jquery.js')); ?>"></script>
    <script src="<?php echo e(URL::to('frontend/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(URL::to('frontend/js/jquery.scrollUp.min.js')); ?>"></script>
